...
curl -X POST http://localhost:9090/api/management/v0.9/websub-apis/{id}/secrets \
  -u {username}:{password} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -d @payload.json
...
curl -X GET http://localhost:9090/api/management/v0.9/websub-apis/{id}/secrets \
  -u {username}:{password} \
  -H 'Accept: application/json'
...
curl -X POST http://localhost:9090/api/management/v0.9/websub-apis/{id}/secrets/{secretName}/regenerate \
  -u {username}:{password} \
  -H 'Accept: application/json'
...
curl -X DELETE http://localhost:9090/api/management/v0.9/websub-apis/{id}/secrets/{secretName} \
  -u {username}:{password} \
  -H 'Accept: application/json'
